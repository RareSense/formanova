...
export default function UnifiedStudio() {
  ...
  // Door-in redirect on insufficient credits is the hook's default; see
  // use-credit-preflight.ts. Nothing to render or wire up here.
  const { checkCredits, checking: preflightChecking } = useCreditPreflight();
