 ...
 * Real search arrives with the backend cad_reference vault (GET /assets
 * ?asset_type=cad_reference&search=), not before — until then the images
 * panel renders no search box rather than a dead one.
 */
